package com.codedifferently.maintanencerequestserver.domain.core.maintenanceRequest.controllers;

import com.codedifferently.maintanencerequestserver.domain.core.maintenanceRequest.models.MaintenanceRequest;
import com.codedifferently.maintanencerequestserver.domain.core.maintenanceRequest.services.MaintenanceRequestService;
...
public class MaintenanceRequestController {
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<MaintenanceRequest> delete(@PathVariable("id") Long id) {
